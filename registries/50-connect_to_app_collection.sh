...
APPCO_FQDN=dp.apps.rancher.io
APPCO_REGISTRY_URL=oci://${APPCO_FQDN}/charts
...
log_into_app_collection() {
  ...
  echo "COMMAND: helm registry login ${APPCO_REGISTRY_URL} -u ${APP_COLLECTION_USERNAME} -p ${APP_COLLECTION_PASSWORD}"
  helm registry login ${APPCO_REGISTRY_URL} -u ${APP_COLLECTION_USERNAME} -p ${APP_COLLECTION_PASSWORD}
  echo
}
...
create_app_collection_secret() {
  ...
  do
    ...
    then
      ...
      then
        echo "COMMAND: kubectl -n ${APP_NAMESPACE} create secret docker-registry ${IMAGE_PULL_SECRET_NAME} --docker-server=${APPCO_FQDN} --docker-username=${APP_COLLECTION_USERNAME} --docker-password=${APP_COLLECTION_PASSWORD}"
        kubectl -n ${APP_NAMESPACE} create secret docker-registry ${IMAGE_PULL_SECRET_NAME} --docker-server=${APPCO_FQDN} --docker-username=${APP_COLLECTION_USERNAME} --docker-password=${APP_COLLECTION_PASSWORD}
        echo
        echo "-----------------------------------------------------------------------------"
        echo
      ...
      then
        echo "COMMAND: kubectl create secret docker-registry ${IMAGE_PULL_SECRET_NAME} --docker-server=${APPCO_FQDN} --docker-username=${APP_COLLECTION_USERNAME} --docker-password=${APP_COLLECTION_PASSWORD}"
        kubectl create secret docker-registry ${IMAGE_PULL_SECRET_NAME} --docker-server=${APPCO_FQDN} --docker-username=${APP_COLLECTION_USERNAME} --docker-password=${APP_COLLECTION_PASSWORD}
        echo
        echo "-----------------------------------------------------------------------------"
        echo
